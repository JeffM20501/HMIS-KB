        ...
        <div className="bg-white rounded-lg border p-6 space-y-5" style={{ borderColor: "#E1E3EA" }}>
            ...
            <div>
                ...
                <input
                    value={slug}
                    readOnly
                    className="w-full px-3.5 py-2.5 text-sm rounded-md border bg-gray-50 cursor-not-allowed"
                    style={{ borderColor: "#E1E3EA", color: "#696E7A" }}
                />
                <p className="text-xs mt-1" style={{ color: "#9EA6B3" }}>
                    The slug is auto‑generated from the title. It must be lowercase, hyphen‑separated, and unique.
                </p>
            </div>
