...
from analytics.views.category_views_view import CategoryViewsView

__all__=['AuditLogViewSet','FeedbackViewSet','ChatLogViewSet','SearchLogViewSet','NotificationViewSet', 'TimeSeriesStatsView','CategoryViewsView']